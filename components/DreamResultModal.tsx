...
const DreamResultModal: React.FC<DreamResultModalProps> = ({ isOpen, onClose, data, userZodiacId, t, lang, onShopeeClick }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center lg:items-center bg-white lg:bg-black/50 transition-all animate-fade-in">
            <div className="w-full h-full lg:h-[850px] lg:max-w-md bg-white relative flex flex-col lg:rounded-3xl lg:shadow-2xl overflow-hidden">
                <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-gray-200 px-4 py-2 flex items-center justify-between h-14">
                    <div className="flex items-center gap-2">
                        <button onClick={onClose} className="w-8 h-8 flex items-center justify-center text-gray-500 hover:text-primary transition-colors"><span className="material-symbols-outlined">arrow_back</span></button>
                        <div>
