...
const DailyFortuneModal: React.FC<DailyFortuneModalProps> = ({ isOpen, onClose, data, birthYear, t, lang, onShopeeClick }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center lg:items-center bg-black/20 lg:bg-black/50 backdrop-blur-[2px] transition-all">
            <div className="w-full h-full lg:h-[850px] lg:max-w-md bg-white relative flex flex-col lg:rounded-3xl lg:shadow-2xl overflow-hidden animate-fade-in">
